adapter_list="['save/amazon/checkpoint-1230','save/sports/checkpoint-1530']"
test_file="testdata/sportswarm.jsonl"
bs=60
gs=4
tta_len=100
func="softmax"
...
test_file="testdata/sportscold.jsonl"
output=result/sportscold
tta_len=50
if [ ! -d ${output} ];then
    mkdir ${output}
fi
