adapter_list="['save/amazon/checkpoint-1230','save/beauty/checkpoint-1200']"
test_file="testdata/beautywarm.jsonl"
bs=60
gs=4
tta_len=100
func="softmax"
...
test_file="testdata/beautycold.jsonl"
output=result/beautycold
tta_len=50
if [ ! -d ${output} ];then
    mkdir ${output}
fi
